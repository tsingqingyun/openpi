...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        data=LeRobotVariousSpeedLiberoDataConfig(
            ...
            assets=AssetsConfig(asset_id="libero_various_speed_pi0"),
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=False,
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi0_base/params"),
    ...
    TrainConfig(
        ...
        data=LeRobotVariousSpeedLiberoDataConfig(
            repo_id="/mnt/data/fangyu/dataset/VariousSpeed/libero_spatial_speed_0p5_1p0_2p0_full_v1_20260428_204431",
            assets=AssetsConfig(asset_id="libero_various_speed_pi05"),
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=False,
        ),
        batch_size=256,
    ...
    TrainConfig(
        name="pi0_libero_various_speed_all",
        model=pi0_config.Pi0Config(),
        data=LeRobotVariousSpeedLiberoDataConfig(
            repo_id="/mnt/data/fangyu/dataset/VariousSpeed/libero_all_speed_0p5_1p0_2p0_full_v1",
            assets=AssetsConfig(asset_id="libero_various_speed_all_pi0"),
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=False,
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi0_base/params"),
    ...
    TrainConfig(
        name="pi05_libero_various_speed_all",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10, discrete_state_input=False),
        data=LeRobotVariousSpeedLiberoDataConfig(
            repo_id="/mnt/data/fangyu/dataset/VariousSpeed/libero_all_speed_0p5_1p0_2p0_full_v1",
            assets=AssetsConfig(asset_id="libero_various_speed_all_pi05"),
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=False,
        ),
        batch_size=256,
